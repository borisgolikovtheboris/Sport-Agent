...
- price: стоимость в рублях (число). «500 рублей», «по 300», «по пятьсот», «цена 5000₽», «5000р», «стоимость 1000» → число.
- recurrence: если пользователь говорит про повторение. Формат:
